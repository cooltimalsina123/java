...
public class HotelController {
    ...
    public HotelController(HotelDao hotelDao, ReservationDao reservationDao) {// here we have a restcontroller called hotelcontroller.
        this.hotelDao = hotelDao; // here we have not instanciated a new object rather we did inject from the memeoryHotel deo thats y we did do hoteldeo = new hotel deo.
        this.reservationDao = reservationDao;// so spring will ask if any body has hotel deo and reservationdeo so if order for
        // spring to know its there in memeory Hotel deo and reservation deo class we must put @componenet on the top before class  so that it can know.
    }
    ...
    public Reservation update(@Valid @RequestBody Reservation reservation, @PathVariable int id) throws ReservationNotFoundException {// we added @valid to make sure our request body is valid.as a resverservation object
